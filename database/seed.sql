...
INSERT INTO suppliers
  (supplier_name, factory_name, product_specialization, quality_rating, delay_frequency, price_range, popular_categories, return_issues, trend_alignment)
VALUES
...
INSERT INTO retailers
  (customer_id, shop_name, market_location, phone_number, preferred_categories, payment_pattern, average_order_size, seasonal_trends, outstanding_balance, preferred_price_segment, notes)
VALUES
  (1, 'Mahalaxmi Fashion Store', 'Birgunj Main Market', '9800000001', 'Cotton, Printed', 'credit_good', 420.00, 'Buys heavily before Dashain and Tihar', 12000.00, 'mid', 'Prefers quick-moving cotton prints under NPR 90.'),
  (2, 'Ganesh Cloth House', 'Adarsh Nagar', '9800000002', 'Suiting, Shirting', 'credit_slow', 280.00, 'School uniform and wedding season demand', 28500.00, 'mixed', 'Negotiates aggressively but repeats fast sellers.'),
  (3, 'City Retail Fabrics', 'Ghantaghar', '9800000003', 'Dress Material, Printed', 'on_delivery', 360.00, 'Festival designs peak September-November', 0.00, 'premium', 'Responds well to photo catalogues.');

INSERT INTO bales
  (bale_code, supplier_id, factory_name, arrival_date, purchase_cost, transport_cost, total_rolls, fabric_category, purchase_invoice, status)
VALUES
...
INSERT INTO thans
  (than_code, bale_id, product_id, fabric_type, color, design, gsm, meter_length, cost_per_meter, selling_price, remaining_stock, warehouse_location, movement_speed, status)
VALUES
...
INSERT INTO transactions
  (retailer_id, than_id, product_id, quantity, price, discount, payment_method, margin, transaction_date)
VALUES
  (1, 1, 9, 12.50, 82.00, 0.00, 'credit', 177.00, '2026-04-09'),
  (3, 6, 7, 15.00, 128.00, 0.00, 'cash', 408.30, '2026-04-12'),
  (2, 3, 1, 8.00, 285.00, 40.00, 'credit', 539.12, '2026-04-18'),
  (1, 2, 9, 5.00, 80.00, 10.00, 'bank', 50.80, '2026-05-01');

INSERT INTO inventory_movements
  (than_id, movement_type, quantity, from_location, to_location, reference_type, reference_id, notes, movement_date)
VALUES
  ...
  (2, 'stock_out', 5.00, 'A1-R2-S4', NULL, 'transaction', 4, 'Repeat sale to Mahalaxmi Fashion Store', '2026-05-01 12:30:00');
